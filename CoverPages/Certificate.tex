...
\vspace{-1.5cm}
\begin{center}
	\Large\textbf{RV College of Engineering, Bengaluru} \\[-0.5em]
	\large{(\textit{Autonomous institution affiliated to VTU, Belagavi})} \\[-0.5em]
	\ifIDP \else\large\textbf{Department of Computer Science and Engineering}\fi
	\vspace{0.5cm}
...
\resizebox{1\textwidth}{!}{%
\begin{tabular}{ccc}
	\large\textbf{\printGuideNameA} & \large\textbf{\printHOD} & \large\textbf{\printPrincipal}\\
	& &\\
