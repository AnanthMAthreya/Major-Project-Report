...
This chapter presents the testing and validation process carried out for the proposed system.
The purpose of software testing is to ensure that the implemented system functions correctly,
satisfies the specified requirements, and performs reliably under different operating
conditions.
...
The end-to-end system testing results generated programmatically by the benchmarking suite in \texttt{benchmark\_pipeline.py} are summarized below:
